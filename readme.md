...
An AngularJS app is to gather suggestions. It will have an interface users can input suggestions into. Submitted suggestions will then appear in a list, which users can add or minus vote, bringing the most popular suggestions to the top of the list. Finally, the app will allow users to comment on suggestions already submitted, so they can add their own two-cents.
...
Link to app: https://geraldgsh.github.io/suggestion-box
